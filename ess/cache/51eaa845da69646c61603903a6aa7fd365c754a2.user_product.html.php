<?php
/* Smarty version 3.1.30, created on 2017-09-07 13:42:53
  from "/www/mecan.net/ess/templates/user_product.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59b0dc5d172dd4_44287256',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'f401169bc13c9e58e4ff0a3a85822e15fcfc0ec1' => 
    array (
      0 => '/www/mecan.net/ess/templates/user_product.html',
      1 => 1504762965,
      2 => 'file',
    ),
...
function content_59b0dc5d172dd4_44287256 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="uk-margin-medium-top">
		...
		<input type="hidden" name="user_id" value="16"/>
			...
			<div uk-form-custom="target: > * > span:first">
				<select id="category" name="category">
					<option value="">品类</option>  					<option value="1" selected>中压元器件</option>
	...
	<div id="modal-price" class="uk-flex-top" uk-modal>
		<div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">
			<form class="uk-form-horizontal uk-margin-large">
				<input type="hidden" id="user_id" value='16' /> <input
	...
	<div class="uk-margin uk-margin-bottom"><div class="pagination"><div class="page-floatR"><span class="page-start right0"><span>上一页</span></span><span class="page-cur right0">1</span><a class="right0" href="http://www.mecan.net/ess/user.php?act=user_product&user_id=16&category=1&page=2">2</a><a class="right0" href="http://www.mecan.net/ess/user.php?act=user_product&user_id=16&category=1&page=3">3</a><a class="right0" href="http://www.mecan.net/ess/user.php?act=user_product&user_id=16&category=1&page=4">4</a><span class="page-break right0">...</span><a class="right0" href="http://www.mecan.net/ess/user.php?act=user_product&user_id=16&category=1&page=14">14</a><a class="right0" href="http://www.mecan.net/ess/user.php?act=user_product&user_id=16&category=1&page=15">15</a><a class="right0" href="http://www.mecan.net/ess/user.php?act=user_product&user_id=16&category=1&page=16">16</a><a href="http://www.mecan.net/ess/user.php?act=user_product&user_id=16&category=1&page=2" class="page-next right0"><span>下一页</span></a></div></div></div>
	</div>
</body>
</html><?php }
}
