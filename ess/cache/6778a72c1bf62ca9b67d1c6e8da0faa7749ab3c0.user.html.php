<?php
/* Smarty version 3.1.30, created on 2017-09-19 15:46:08
  from "E:\www\eps\ess\templates\user.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59c0cb40946386_57555252',
...
function content_59c0cb40946386_57555252 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
	...
	<ul class="uk-flex-center " uk-tab>
		...
		<table class="uk-table uk-table-striped">
			...
			<tbody>
					...
					<td>18</td>
					<td><img class="uk-preserve-width" src="avatar/20170919093562569173_0.jpeg"
						width="40"> <span class="uk-text-primary">默默</span>
					</td>
					<td>13306118316</td>
					<td>普通成员</td>
					<td>男</td>
					<td>0/0</td>
					<td>2017-09-19 09:35:04</td>
					<td>无</td>
					<td><span class="green">√</span>					</td>
					<td><a href="#set_utype" class="uk-text-small uk-text-primary"
						id="set_utype_18_普通成员" uk-toggle>设置用户类型</a>
						&nbsp;&nbsp;<a
						href="user.php?act=score_record&user_id=18"
						class="uk-text-small uk-text-primary">积分与兑现</a> &nbsp;&nbsp; <a
						href="user.php?act=user_product&user_id=18"
						class="uk-text-small uk-text-primary">设置产品结算价格</a></td>
				</tr>
								<tr class="uk-text-small">
					<td>17</td>
					<td><img class="uk-preserve-width" src="img/avatar.png"
						width="40"> <span class="uk-text-primary">赵辉</span>
					</td>
					<td>18262999688</td>
					<td>普通成员</td>
					<td>男</td>
					<td>0/0</td>
					<td>2017-09-08 23:17:35</td>
					<td>无</td>
					<td><span class="green">√</span>					</td>
					<td><a href="#set_utype" class="uk-text-small uk-text-primary"
						id="set_utype_17_普通成员" uk-toggle>设置用户类型</a>
						&nbsp;&nbsp;<a
						href="user.php?act=score_record&user_id=17"
						class="uk-text-small uk-text-primary">积分与兑现</a> &nbsp;&nbsp; <a
						href="user.php?act=user_product&user_id=17"
						class="uk-text-small uk-text-primary">设置产品结算价格</a></td>
				</tr>
								<tr class="uk-text-small">
					<td>16</td>
