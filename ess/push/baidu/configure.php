...
class BAIDU_PUSH_CONFIG
{
     ...
     * @var string
     */
    // const default_apiKey = 'YCKZYkCgV41IX1K8npkemG0bWGIOTOt2';//'5f3U7aWrmHp7gefd4OADxLti';
    const default_apiKey = 'w24aC28oXLU0Qwz3pUcQwC7v';
     ...
     * @var string
     */
    const default_secretkey = 'O6Yql6TcCMCtZWgwI1IaVbzjYfrvwaqs';
    //const default_secretkey = 'QW8jrXwloml4xMl9DsG6xrQECUPQiH1H';
 // 'CDfrX5VrLfz520dAVfFrviwBc2HsMj5k';
 ...
 // 开发状态, rd开发时使用, 最详细 log. 发布后被移除
    const LOG_LEVEL_TRACE = 1;
 // 开发者开发时状态,隐藏rd开发时的细碎信息
    const LOG_LEVEL_ONLINE = 2;
 // 开发者线上使用, 只有fault和warn
    const LOG_LEVEL_ONLINE_FAULT = 3;
 // 开发者线上使用, 只有fault
    const LOG_LEVEL_ONLINE_SILENCE = 4;
 // 静默.
