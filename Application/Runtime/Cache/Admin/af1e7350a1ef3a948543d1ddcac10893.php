...
<style type="text/css">
 ...
 <form name="searchform" action="<?php echo U('Clerk/performance_f');?>" method="get"  class="well form-search" id="searchform">
<div class="search_type cc mb10">
	...
	<ul class="nav nav-tabs">
		<li><a href='<?php echo U("Clerk/performance");?>' >需求方业绩表</a></li>
		<li class="active"><a href='<?php echo U("Clerk/performance_f");?>' >服务方业绩表</a></li> 
	</ul>
	...
	<div class="table-list">
	    <table width="100%" class="table table-hover">
	      ...
	      <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
	          ...
	          <td width="10%" ><?php echo ($v["mobile"]); ?><br /><?php echo ($v["company"]); ?></td>
	          <td width="10%" ><?php echo ($v["get_reward"]); ?></td>
			  <td width="10%" ><?php echo ($v["time"]); ?></td>
			  <td width="10%" ><?php echo ($v["reward_time"]); ?></td>
