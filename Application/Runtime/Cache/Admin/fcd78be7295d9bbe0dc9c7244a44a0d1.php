...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		<li class="active"><a href='<?php echo U("Finance/lists");?>'>全部</a></li>
		<li><a href='<?php echo U("Finance/billing");?>'>待开票</a></li>
		<li><a href='<?php echo U("Finance/mailing");?>' >待邮寄</a></li>
		<li><a href='<?php echo U("Finance/completed");?>' >已完成</a>
	</ul>
	<form name="searchform" action="<?php echo U('Finance/lists');?>" method="get"  class="well form-search" id="searchform">
	...
	<div class="search_type cc mb10">
	 <div class="mb10">
	  ...
	  <b style="float:right">待开票总金额：<?php echo ($reward); ?> 元 | 当前待开票金额：<?php echo ($d_reward); ?></b>
	 </div>
	</div>
  </form>
	...
	<div class="table-list">
	    <table width="100%" class="table table-hover">
	      ...
	      <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
			  ...
			  <td width="10%" style="text-align:center" class="status<?php echo ($v["billing"]); ?>"><?php echo ($v["billing_v"]); ?></td>
			  <td width="10%" style="text-align:center" class="status1<?php echo ($v["pay_mode"]); ?>"><?php echo ($v["pay_status"]); ?></td>
