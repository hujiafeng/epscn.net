...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href='<?php echo U("Finance/mailing");?>' >待邮寄</a></li>
		<li><a href='<?php echo U("Finance/completed");?>' >已完成</a></li>
	</ul>
	<form name="searchform" action="<?php echo U('Finance/mailing');?>" method="get"  class="well form-search" id="searchform">
	...
	<div class="table-list">
	    <table width="100%" class="table table-hover">
	      ...
	      <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
			  ...
			  <td width="10%" style="text-align:center" class="status1">待邮寄</td>
			  <td width="10%" style="text-align:center" class="status<?php echo ($v["pay_mode"]); ?>"><?php echo ($v["pay_status"]); ?></td>
	          <td width="15%"  align="center">
			   <a href="<?php echo U('Finance/mailing_add',array('id'=>$v['id']));?>">确认已邮寄</a> |
