...
<style type="text/css">
	...
	<form name="searchform" action="<?php echo U('Gongdan/cancel');?>" method="get"  class="well form-search" id="searchform">
<div class="search_type cc mb10">
	 <div class="mb10">
              <input type="text" value="<?php echo ($_GET['no']); ?>" class="input-text" name="no" placeholder="请输入订单号" />
			  &nbsp;
	    ...
	    <table width="100%" class="table table-hover">
	      <thead>
	        <tr>
			  ...
			  <th width="5%" align="left" >需求方</th>
			  <th width="10%" align="left" >服务商</th>
	      ...
	      <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
	          ...
	          <td width="5%" ><?php echo ($v["k_title"]); ?></td>
			  <td width="15%" ><?php echo ($v["u_mobile"]); ?><br /><?php echo ($v["khdw"]); ?></td>
			  <td width="10%" ><?php echo ($v["u_company"]); ?></td>
