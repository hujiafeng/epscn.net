...
<div class="wrap jj">
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href='<?php echo U("Finance/completed");?>' >已完成</a></li>
	</ul>
	<form name="searchform" action="<?php echo U('Finance/completed');?>" method="get"  class="well form-search" id="searchform">
