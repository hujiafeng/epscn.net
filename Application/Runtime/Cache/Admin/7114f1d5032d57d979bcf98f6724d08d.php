...
<script type="text/javascript">
 ...
 <div class="wrap jj">
    <ul class="nav nav-tabs">
		<li class="active"><a href='#' >修改服务顾问</a></li> 
     </ul>
<div class="pad_10">
  <div class="common-form">
    <form name="myform" action="<?php echo U('Clerk/edit');?>" method="post" id="myform">
...
<table width="100%" class="table_form contentWrap">
		...
		<tr>
            <td width="80">备注</td>
			<td><input type="text" name="info[remark]" class="input-text" value="<?php echo ($info["remark"]); ?>" style="width:400px;"> 例:离职</td>
        </tr>
        </tbody>
      </table>
	</div>
