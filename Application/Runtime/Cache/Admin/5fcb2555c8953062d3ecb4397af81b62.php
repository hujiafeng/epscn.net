...
<style type="text/css">
	...
	<form name="searchform" action="<?php echo U('Yonghu/lists');?>" method="get"  class="well form-search" id="searchform">
<div class="search_type cc mb10">
	 <div class="mb10"> 
              <input type="text" value="<?php echo ($_GET['title']); ?>" class="input-text" name="title" placeholder="请输入手机/姓名" />
			  &nbsp;
	    ...
	    <table width="100%" class="table table-hover">
	      <thead>
	        <tr>
			  ...
			  <th width="12%" align="left" >客户单位</th>
			  <th width="10%" align="left" >(需)业务员</th>
			  <th width="10%" align="left" >(服)业务员</th>
	          <th width="38%" >操作</th>
	        </tr>
	      </thead>
	      <tbody>
	      <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
			  ...
			  <td width="12%" ><?php echo ($v["khdw"]); ?></td>
			  <td width="10%" ><?php echo ($v["clerk_x_name"]); ?></td>
			  <td width="10%" ><?php echo ($v["clerk_f_name"]); ?></td>
	          <td width="38%"  align="center">
	          <a href="<?php echo U('Yonghu/show',array('id'=>$v['uid']));?>">查看</a>
			   | <span class="delbtn" data="<?php echo U('Yonghu/reset',array('id'=>$v['uid']));?>" cont="重置后密码88888888？" >密码重置</span>
			  <?php if($v["flag"] == '1'): ?>| <span>已屏蔽</span>
			  <?php else: ?>
			  | <span class="delbtn" data="<?php echo U('Yonghu/del',array('id'=>$v['uid']));?>" cont="确定屏蔽该用户？" >屏蔽</span><?php endif; ?>
			  | <a href="<?php echo U('Yonghu/clerk',array('id'=>$v['uid']));?>">解绑业务员</a>
			  <?php if($v["type"] == '0'): ?>| <a href="<?php echo U('Fwuser/request',array('id'=>$v['uid']));?>">认证服务商</a><?php endif; ?>
			   | <a href="<?php echo U('Device/Clists',array('uid'=>$v['uid']));?>">设备管理</a>
	          </td>
