...
require_once PUSH_SDK_HOME . '/iosconfigure.php';
 ...
 *         
 */
class PushIOSSDK extends BaseSDK {
    const VERSION = '3.0.0';
    ...
    function __construct($apiKey = null, $secretKey = null, $curlopts = array()) {
        ...
        if($apiKey !== null && $secretKey !== null){
            ...
            $this -> setApiKey(BAIDU_PUSH_CONFIG_IOS::default_apiKey);
            $this -> setSecretKey(BAIDU_PUSH_CONFIG_IOS::default_secretkey);
        }
